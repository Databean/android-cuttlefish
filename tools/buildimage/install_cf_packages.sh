...
cp ${packages_dir}/cuttlefish-user*_amd64.deb ${mount_point}/tmp/
...
sudo chroot ${mount_point} apt install -y /tmp/cuttlefish-base_*_amd64.deb
sudo chroot ${mount_point} apt install -y /tmp/cuttlefish-user_*_amd64.deb
sudo chroot ${mount_point} apt install -y /tmp/cuttlefish-orchestration_*_amd64.deb
