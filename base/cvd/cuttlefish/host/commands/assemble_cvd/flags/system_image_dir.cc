...
Result<SystemImageDir> SystemImageDir::FromFlags() {
  ...
  return SystemImageDir(std::move(paths));
}

std::string SystemImageDir::ForIndex(size_t argument_index) const {
...
SystemImageDir::SystemImageDir(std::vector<std::string> system_image_dirs)
